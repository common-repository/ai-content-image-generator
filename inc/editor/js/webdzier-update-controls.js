            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#opaigpt_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('opaigpt_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="opaigpt_feature_thumbnail-button">' +
                            ...
                            '<button type="button" class="button upload-button control-focus" id="opaigpt_feature_thumbnail-button">Change Image</button> ' +
